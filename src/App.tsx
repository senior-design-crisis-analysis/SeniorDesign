  ...
  const filteredPosts = useMemo(() => {
    ...
    return posts.filter(
      (p) =>
        ...
        (disaster === undefined ||
          (p.disaster_type && p.disaster_type.toLowerCase() === disaster)) && //displays posts of disaster filter
        (severity === undefined ||
          (p.severity_level && p.severity_level.toLowerCase() === severity)) //displays posts of severity filter
    );
