    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString("default", { month: "long" }), // Changed to full month name
        ...formatters,
      }}
      classNames={{
        ...
        dropdowns: cn(
          "w-full flex items-center text-sm font-medium justify-center h-(--cell-size) gap-2", // Increased gap
          defaultClassNames.dropdowns
        ),
        dropdown_root: cn(
          "relative has-focus:border-ring border border-input shadow-xs has-focus:ring-ring/50 has-focus:ring-[3px] rounded-md min-w-[120px]", // Added min-width for better spacing
        ...
        range_start: cn(
          "rounded-l-md bg-primary", // Proper rounded start
          defaultClassNames.range_start
        ),
        range_middle: cn(
          "bg-accent rounded-none", // Background shading for range
          defaultClassNames.range_middle
        ),
        range_end: cn(
          "rounded-r-md bg-primary", // Proper rounded end
